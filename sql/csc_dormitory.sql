...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2253688215ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3c334923703a7b745d335f5a35646f2e">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT dormitory_detail.dormitory_id, map, other, line, facebook, ig, image_1, image_2, image_3, image_4, image_5 FROM dormitory_detail INNER JOIN image_detail ON dormitory_detail.dormitory_id = image_detail.dormitory_id where dormitory_detail.dormitory_id = 3;</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT `map` FROM `dormitory_detail` WHERE `dormitory_detail`.`id` = 3</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="csc_dormitory" targettable="dormitory_detail">
                            <div class="action_content">
